...
i = 1;
while true
    McIlwain_forward(i) = only_McIlwain(5775+i); %#ok<SAGROW>
    del_McIlwain = only_McIlwain(5775+i)-only_McIlwain(5775+i-1);
    i = i + 1;
    if only_McIlwain(5775+i) < 1.2 || del_McIlwain <= 0
        break
    end
end
...
i = 1;
while true
   McIlwain_backward(i) = only_McIlwain(5891+i); %#ok<SAGROW>
   del_McIlwain = only_McIlwain(5891+i+1)-only_McIlwain(5891+i);
   i = i + 1;
   if only_McIlwain(5891+i) < 1.2 || del_McIlwain >= 0
       break
   end
...
L = 1/((cosd(70))^2);
pf_for = Omni_directional_P6(46201:8:46697);
