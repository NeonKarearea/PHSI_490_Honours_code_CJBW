clear all %#ok<CLALL>
close all
load('E:\PHSI 490\POES data PHSI 490\NOAA19\poes_n19_20120123.mat')
...
i = 1;
while true
    McIlwain_forward(i) = only_McIlwain(8062+i); %#ok<SAGROW>
    del_McIlwain = only_McIlwain(8062+i)-only_McIlwain(8062+i-1);
    i = i + 1;
    if only_McIlwain(8062+i) < 1.2 || del_McIlwain <= 0
        break
    end
end
...
i = 1;
while true
   McIlwain_backward(i) = only_McIlwain(8171+i); %#ok<SAGROW>
   del_McIlwain = only_McIlwain(8171+i+1)-only_McIlwain(8171+i);
   i = i + 1;
   if only_McIlwain(8171+i) < 1.2 || del_McIlwain >= 0
       break
   end
...
L = 1/((cosd(70))^2);
pf_for = Omni_directional_P6(64501:8:64945);
pf_back = Omni_directional_P6(65369:8:66352);
...
scale=axis;
axis([datenum(2012,1,23,17,55,0) datenum(2012,1,23,18,20,0) 0 scale(4)])
...
scale=axis;
axis([datenum(2012,1,23,12,50,0) datenum(2012,1,23,13,15,0) 0 25])
datetick('x',15,'keeplimits')
set(gca,'FontSize',20,'FontWeight','demi')
